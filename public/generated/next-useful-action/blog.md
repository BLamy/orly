...
{% viz scene="books/next-useful-action/chapter-1" section="chapter-1-the-work-between-useful-actions" cue="1" from="0.000" to="45.200" title="The work between useful actions" %}
{% endviz %}
...
{% viz scene="books/next-useful-action/chapter-1" section="chapter-1-a-suggestion-and-an-authorized-action" cue="5" from="45.200" to="90.200" title="A suggestion and an authorized action" %}
{% endviz %}
...
{% viz scene="books/next-useful-action/chapter-2" section="chapter-2-a-page-bounds-the-choice" cue="1" from="0.000" to="46.400" title="A page bounds the choice" %}
{% endviz %}
...
{% viz scene="books/next-useful-action/chapter-2" section="chapter-2-legal-does-not-mean-useful" cue="5" from="46.400" to="92.600" title="Legal does not mean useful" %}
{% endviz %}
...
{% viz scene="books/next-useful-action/chapter-3" section="chapter-3-different-objectives-share-an-observation" cue="1" from="0.000" to="44.000" title="Different objectives share an observation" %}
{% endviz %}
...
{% viz scene="books/next-useful-action/chapter-3" section="chapter-3-build-the-foundation-before-claiming-the-product" cue="5" from="44.000" to="89.000" title="Build the foundation before claiming the product" %}
{% endviz %}
