...
const meta: Meta<typeof Chapter> = { title: 'Books/The Runtime Controller/Chapter 4', component: Chapter };
export default meta;
export const StrictSuccessIsExpensive: StoryObj<typeof Chapter> = {};
