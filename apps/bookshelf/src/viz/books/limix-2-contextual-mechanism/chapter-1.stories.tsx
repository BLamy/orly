...
const meta: Meta<typeof Chapter> = { title: 'Books/The Masked Mechanism/Chapter 1', component: Chapter };
export default meta;
export const EveryCellKeepsItsPlace: StoryObj<typeof Chapter> = {};
