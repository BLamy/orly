...
export default {title:'Books/The Hidden Involution/Chapter 2',component:Chapter} satisfies Meta<typeof Chapter>;
export const NearHypercube: StoryObj<typeof Chapter> = {};
