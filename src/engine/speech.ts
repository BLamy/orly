// Text-to-speech for narrating slides, using the browser's Web Speech API.
// Same voice preference as the standalone "say" artifact: Google UK English Male
// (a Chrome network voice), falling back to any en-GB / en / available voice.
 ...
 * identifiers, etc. — into plain words. A step's `say` field bypasses this.
 */
